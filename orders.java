...
//
// Debug information:
// Generated date: Sun Dec 27 20:11:39 GMT 2020
...
public class orders extends SqoopRecord  implements DBWritable, Writable {
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.order_customer_id = JdbcWritableBridge.readInteger(1, __dbResults);
    this.order_date = JdbcWritableBridge.readTimestamp(2, __dbResults);
    this.order_id = JdbcWritableBridge.readInteger(3, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    JdbcWritableBridge.writeInteger(order_customer_id, 1 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeTimestamp(order_date, 2 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeInteger(order_id, 3 + __off, 4, __dbStmt);
...
this.readFields0(__dataIn);  }
  ...
  public void setField(String __fieldName, Object __fieldVal) {
    if ("order_customer_id".equals(__fieldName)) {
